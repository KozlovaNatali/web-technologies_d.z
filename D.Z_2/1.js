...
const temperatureInDegreesCelsius = +prompt('Введите температуру в градусах цельсия: ')

function temperatureInDegreesFahrenheit(temperatureInDegreesCelsius) {
    Fahrenheit = (9/5) * temperatureInDegreesCelsius + 32
    return Fahrenheit.toFixed(2)
    }
alert(`Цельсий: ${temperatureInDegreesCelsius}, Фаренгейт: ${temperatureInDegreesFahrenheit(temperatureInDegreesCelsius)}`)    